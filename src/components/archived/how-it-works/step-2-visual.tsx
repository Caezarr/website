...
export function Step2Visual() {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center gap-[0.8cqw]">
      <Image
        src="/images/archived/how-it-works/step-2/pill-top.png"
        alt=""
        width={184}
        height={69}
      ...
      />
      <Image
        src="/images/archived/how-it-works/step-2/pill-center.png"
        alt=""
        width={183}
        height={65}
      ...
      />
      <Image
        src="/images/archived/how-it-works/step-2/pill-bottom.png"
        alt=""
        width={202}
        height={69}
